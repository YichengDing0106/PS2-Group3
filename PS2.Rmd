...
```{r echo=FALSE}
par(mar=c(10,4,2,2))
barplot(table(feelings_life_data.clean$family_income), names.arg = c('Less than $25,000', '$25,000 to $49,999', '$50,000 to $74,999', '$75,000 to $99,999', '$100,000 to $ 124,999', '$125,000 and more'), las = 2, main="Figure_2: Barplot of Family Income", ylab = "Count", ylim = c(0,5000))
...
Figure 3 is the distribution of total amount of children owned by each repsondent. We can find that it is a right skewed distribution. Most respondents have 0-3 children and few respondents have 6 to 7 children.
...
Figure 4 is a bar plot of feeling about life as a whole, which can be translate into "Are you satisfied with your life?". From level 0 - 10, satisfaction increased gradually, so 0 means very dissatisfied and 10 means very satisfied. The distribution for this plot is left skewed which means most respondents are satisfied with their lives. Only a few respondents choose under level 5. Most respondents chose 8 which means they think their lives can be further improved.
